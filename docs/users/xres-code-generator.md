---
title: 代码生成器
description: xres-code-generator 的使用和定制
---
# 使用 [xres-code-generator](https://github.com/xresloader/xres-code-generator) 生成解析代码

[xres-code-generator](https://github.com/xresloader/xres-code-generator) 是一个基于 [mako](https://www.makotemplates.org/) 模板引擎的代码生成工具，其内部提供了一些模板用于生成加载 [xresloader](https://github.com/xresloader) 所生成的数据的代码。

仓库地址: [https://github.com/xresloader/xres-code-generator](https://github.com/xresloader/xres-code-generator)

## 第一步，在proto文件中声明加载器和索引类型

导入 `import "xrescode_extensions_v3.proto";` 然后声明loader。更多可选项见: [xres-code-generator 插件](https://github.com/xresloader/xres-code-generator/blob/main/pb_extension/xrescode_extensions_v3.proto)
...
1.  从 [xres-code-generator/template/common/cpp](https://github.com/xresloader/xres-code-generator/tree/main/template/common/cpp) 拷贝公共代码
...
使用示例可参见 [xres-code-generator/sample](https://github.com/xresloader/xres-code-generator/tree/main/sample) ，使用 `sample_gen.sh` 可生成协议代码和加载示例代码。
...
1.  从 [xres-code-generator/template/common/lua](https://github.com/xresloader/xres-code-generator/tree/main/template/common/lua) 拷贝公共代码
...
## 生成基于 [upb](https://github.com/protocolbuffers/upb) 的Lua加载代码

1.  编译 [upb](https://github.com/protocolbuffers/upb) 运行时和 [upb](https://github.com/protocolbuffers/upb) 内lua binding内的 `protoc-gen-lua` 插件

2.  从 [xres-code-generator/template/common/upblua](https://github.com/xresloader/xres-code-generator/tree/main/template/common/upblua) 拷贝公共代码

3.  使用 [upb](https://github.com/protocolbuffers/upb) 的 `protoc-gen-lua` 插件生成lua表述信息
...
我们实现的所有加载代码模板都位于 [xres-code-generator/template](https://github.com/xresloader/xres-code-generator/tree/main/template) ，以后会实现更多语言的加载模板。用户也可以根据自己的需要，参照 [xres-code-generator/template](https://github.com/xresloader/xres-code-generator/tree/main/template) 实现自己的代码加载模板。
