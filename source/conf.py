...
release = 'https://xresloader.atframe.work'
...
latex_documents = [
    (master_doc, 'xresloader-document.tex', 'xresloader-document Documentation',
     'owent', 'manual'),
]
...
man_pages = [
    (master_doc, 'xresloader-document', 'xresloader-document Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'xresloader-document', 'xresloader-document Documentation',
     author, 'xresloader-document', 'One line description of project.',
     'Miscellaneous'),
]
